...
class _Home5State extends State<Home5> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Etape6",style: TextStyle(color: Palette.white),),
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Center(
                child: Text("Affiliés au Fonds Secteur Public"),
              ),
            ),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: (){
          Navigator.push(context, MaterialPageRoute(builder: (context) => Home7()));
